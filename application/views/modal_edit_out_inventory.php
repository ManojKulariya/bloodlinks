<?php echo form_open('inventory/update1/' . $param2, array('id' => 'edit_out_inventory', 'method' => 'post', 'data-parsley-validate' => 'true')); ?>
<?php
...
?>
	...
	<div class="form-group">
	 ...
	 <div class="form-group">
        <label><?php echo $this->lang->line('Out Inventory'); ?> Out Inventory</label>
            <input name="out_inventory" type="text" class="form-control"  placeholder="<?php echo $this->lang->line('out_inventory'); ?>" data-parsley-required="true" />
    </div>
    <div class="form-group">

    ...
    <div data-scrollbar="true" data-height="100%">
        ...
        <ul class="nav">
            ...
            <!--Invoice Services-->
                ...
                <li class="has-sub <?php if ($page_name == 'invoice_service' || $page_name == 'add_service_invoice' || $page_name == 'generate_service_invoice' ) echo 'active'; ?>">
                    <a href="javascript:;">
                        <b class="caret"></b>
                        <i class="fa fa-laptop"></i>
                        <span><?php echo $this->lang->line(''); ?>Service Invoice</span>
                    </a>
                    <ul class="sub-menu">
                        <li class="<?php if ($page_name == 'add_service_invoice' || $page_name == 'service_invoice') echo 'active'; ?>">
                            <a href="<?php echo base_url(); ?>service_invoice">Service Invoice</a>
                        </li>
                    </ul>
                </li>
     
            <!--Invoice Services end-->
            ...
            <!--inventory-->
                ...
                <li class="has-sub <?php if ($page_name == 'inventory' || $page_name == 'add_inventory' || $page_name == 'inventory_categories') echo 'active'; ?>">
                    <a href="javascript:;">
                        <b class="caret"></b>
                        <i class="fa fa-laptop"></i>
                    ...
                    <ul class="sub-menu">
                        <li class="<?php if ($page_name == 'add_inventory' || $page_name == 'inventory') echo 'active'; ?>">
                            <a href="<?php echo base_url(); ?>inventory"><?php echo $this->lang->line('inventory'); ?></a>
                        </li>
                        <li class="<?php if ($page_name == 'add_category' || $page_name == 'category') echo 'active'; ?>">
                            <a href="<?php echo base_url(); ?>category"><?php echo $this->lang->line('inventory_category'); ?>Inventory Category</a>
                        </li>
                        <li class="<?php if ($page_name == 'add_sub_category' || $page_name == 'sub_category') echo 'active'; ?>">
                            <a href="<?php echo base_url(); ?>sub_category"><?php echo $this->lang->line('inventory_category'); ?>Inventory Sub Category</a>
                        </li>
                    </ul>
                </li>
            ...
            <?php if (in_array($this->db->get_where('module', array('module_name' => 'reports'))->row()->module_id, $this->session->userdata('permissions'))) : ?>
                <li class="has-sub <?php if ($page_name == 'rents_report' || $page_name == 'single_year_rents_report' || $page_name == 'expenses_report' || $page_name == 'single_year_expenses_report' || $page_name == 'utilities_report' || $page_name == 'single_year_utilities_report') echo 'active'; ?>">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="<?php if ($page_name == 'expenses' || $page_name == 'single_year_expenses_report') echo 'active'; ?>">
                            <a href="<?php echo base_url(); ?>expenses"><?php echo $this->lang->line('expenses'); ?></a>
                        </li>
            ...
            <li class="<?php if ($page_name == 'board_members') echo 'active'; ?>">
                <a href="<?php echo base_url(); ?>board_members">
                    ...
                    <span><?php echo $this->lang->line(''); ?>Staff Attendance</span>
                </a>
            </li>

                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $this->db->get_where('invoice', array('invoice_id' => $tenant_rent['invoice_id']))->row()->total_amount; ?></td>
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label>Month *</label>
                        <div>
                            <select style="width: 100%" class="form-control default-select2" data-parsley-required="true" name="month" id="month">

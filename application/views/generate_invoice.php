            ...
            <div class="panel panel-inverse">
                ...
                <ul class="nav nav-tabs nav-tabs-inverse nav-justified nav-justified-mobile">
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a href="#service" data-toggle="tab" class="nav-link">
                            <span class="d-md-inline">Services</span>
                        </a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane fade active show" id="date-range">
                        ...
                        <div class="form-group">
                            <label><?php echo $this->lang->line('Tax'); ?>Tax</label>
                            <div>
                                <select style="width: 100%" class="form-control default-select2" data-parsley-required="true" name="tax">
                                    <option value="0"><?php echo $this->lang->line('select_status'); ?></option>
                                    <option value="5"><?php echo $this->lang->line('5'); ?>CSGT 2.5% And SGST: 2.5% </option>
                                    <option value="12"><?php echo $this->lang->line('12'); ?>CSGT 6% And SGST: 6%</option>
                                    <option value="18"><?php echo $this->lang->line('18'); ?>CSGT 9% And SGST: 9%</option>
                                </select>
                            </div>
                        </div>
                        
                        <div class="form-group">
                            <label><?php echo $this->lang->line(''); ?>Discount Amount</label>
                            <input name="amount" value="0" type="text" class="form-control" placeholder="<?php echo $this->lang->line('amount'); ?>" />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <select style="width: 100%" class="form-control default-select2" data-parsley-required="true" name="tax">
                                    <option value="0"><?php echo $this->lang->line('select_status'); ?></option>
                                   <option value="5"><?php echo $this->lang->line('5'); ?>CSGT 2.5% And SGST: 2.5% </option>
                                    <option value="12"><?php echo $this->lang->line('12'); ?>CSGT 6% And SGST: %</option>
                                    <option value="18"><?php echo $this->lang->line('18'); ?>CSGT 9% And SGST: 9%</option>
                                </select>
                            </div>
                        </div>

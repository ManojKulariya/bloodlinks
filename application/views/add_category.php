        ...
        <div class="col-lg-6 offset-lg-3">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <?php echo form_open('category/add', array('method' => 'post', 'data-parsley-validate' => 'true')); ?>
                    
                      <div class="form-group">
                            <label><?php echo $this->lang->line('category_name'); ?> Category Name</label>
                            <input name="name" type="text" class="form-control"  placeholder="<?php echo $this->lang->line('category'); ?>"  />
                        </div>

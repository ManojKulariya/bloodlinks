 ...
 * 
 */
class BaseHospitalController extends CI_Controller
{
    public $data = array();
    ...
    function __construct()
    {
        ...
        $this->data['base_url'] = base_url('hospital');
        ...
        if (session_userdata('isHospitalLoggedin') == TRUE) {

...
if (isset($_POST['captcha']) && $_POST['captcha'] == $_POST['captcha_word']) {
   ...
   $org_parent_hospital = $_POST['org_parent_hospital'];
   ...
   $pw = $_POST['password'];
   $hash_pw = password_hash($pw,PASSWORD_BCRYPT, array('cost' => 12));



   $insert = $this->db->query("INSERT INTO bl_users (role_id, email, password, user_status, user_verified) VALUES ('5', '$org_email','$hash_pw', 'active', 'yes')");
   $last_id = $this->db->insert_id();
   if ($insert == true) {
      $insert1 = $this->db->query("INSERT INTO bl_blood_banks (user_id , name , short_name , org_type , latitude , longitude , state_id , city_id , district_id, pincode, address_1 , category_id , parent_hospital_id , contact_person , contact_email , contact_ph_no , lic_no , lic_valid_from , lic_valid_to , boarding_type) VALUES ('$last_id','$org_name','$org_short_name','Blood Bank', '$latitude', '$longitude' , '$org_state','$org_city' , '$org_districs' , '$org_pincode' , '$org_address1' , '$org_category' , '$org_parent_hospital', '$org_contact_name','$org_email' , '$org_ph_no' , '$org_lic_no' , '$org_lic_valid_from' , '$org_lic_valid_to', 'offboarding')");
...
<div class="row justify-content-center" style="  background:#faf9fb;">
   <div class="col-xl-6">
      <div class="card">
                  ...
                  <form action="<?php $_PHP_SELF ?>" method="POST" class="login-box">
                     ...
                     <div class="row">
                        <div class="col-md-12" style="padding: 20px;">
                           ...
                           <div class="row mb-3">
                              <label for="colFormLabel" class="col-sm-4 col-form-label">Parent Hospital</label>
                              <div class="col-sm-8">
                           ...
                           <div class="row mb-3">
                              ...
                              <div class="col-sm-8">
                                 <input type="email" class="form-control" name="org_email" id="org_email" placeholder="Enter Email address" oninput="$('#org_username').val($('#org_email').val())" value="<?php echo (isset($blood_bank_data)) ? $blood_bank_data->contact_email : ''; ?>">
                              </div>
                           </div>
                           <div class="row mb-3">
                              ...
                              <div class="col-sm-8">
                                 ...
                                 <small class="text-muted">Password must be at least 8 characters, contain at least one uppercase letter, one lowercase letter, one digit, and one special character (!@#$%^&)</small>
                              </div>
                           </div>
                           <div class="row mb-3">
                           ...
                           <?php 
                            $this->load->view('common/location_picker', [
                                'label'   => 'Blood Bank Location',
                                'mapId'   => 'map1',
                           ...
                           <div class="row mb-3">
                              ...
                              <div class="col-sm-8">
                                 <input type="text" class="form-control" name="latitude" id="latitude" placeholder="Enter Latitude" value="26.9124">
                              </div>
                           </div>
                           <div class="row mb-3">
                              <label for="colFormLabel" class="col-sm-4 col-form-label">Longitude</label>
                              <div class="col-sm-8">
                                 <input type="text" class="form-control" name="longitude" id="longitude" placeholder="Enter Longitude" value="75.7873">
                              </div>
                           </div>
                           <div class="row mb-3">
...
<script type="text/javascript">
    window.addEventListener('load', function () {
        if (typeof initMap_map1 === 'function') {
            initMap_map1();
        }
    });

 ...
 <div class="image-contactus-banner">
    <div class="container">
        <div class="row">
              ...
              <h6><a href="<?php echo base_url();?>">Home /</a> Request for Blood Donation</h6>
           	</div>
        </div>
    </div>
</div>
        ...
        <div class="row justify-content-center ">
           	<div class="col-xl-9  text-center ">
              	<div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                	<h2 id="heading">Request for Blood Donation </h2>
...
<script type="text/javascript">
   var form_load_url='<?php echo base_url('donation_request_forms');?>';
</script>

...
if (isset($_POST['captcha']) && $_POST['captcha'] == $_POST['captcha_word']) {
   ...
   if ($insert == true) {
      $insert1 = $this->db->query("INSERT INTO bl_blood_banks (user_id , name , short_name , org_type , website ,
                        blood_center , latitude , longitude , state_id , city_id , district_id, pincode, address_1 , category_id , contact_email , contact_ph_no , lic_no , lic_valid_from , lic_valid_to , boarding_type) VALUES ('$last_id','$org_name','$org_short_name','Hospital', '$latitude', '$longitude' , '$org_state','$org_city' , '$website', '$blood_center' , '$org_districs' , '$org_pincode' , '$org_address1' , '$org_category' , '$org_email' , '$org_ph_no' , '$org_lic_no' , '$org_lic_valid_from' , '$org_lic_valid_to', 'offboarding')");
...
<div class="row justify-content-center addhos-row3" style="background:faf9fb !important;">
   <div class="col-xl-6">
      <div class="card">
         <!-- <div class="card-header text-center">/ -->
         <!-- <h3 class="card-title">Hospital Details</h3> -->
         <!--  <div class="btn-group" style="float: right;">
               <a href="<?php echo $base_url; ?>/hospitals" data-toggle="tooltip" title="" class="btn btn-sm btn-default" data-original-title="Add New"><i class="fas fa-reply fw"></i></a>
            </div> -->
         <!-- </div> -->
         <div class="card-body">
               ...
               <div class="tab-pane fade <?php echo (!session_userdata('next_step')) ? 'show active' : ''; ?>" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                  <form action="<?php $_PHP_SELF ?>" method="POST" class="login-box">
                     ...
                     <div class="row">
                        <div class="col-md-12" style="padding: 20px;">
                           <div class="row mb-3">
                              <label for="colFormLabel" class="col-sm-4 col-form-label">Hospital Name</label>
                              <div class="col-sm-8">
                           ...
                           <div class="row mb-3">
                              <label for="colFormLabel" class="col-sm-4 col-form-label">Website</label>
                              <div class="col-sm-8">
                                 <input type="text" class="form-control" name="website" id="website" placeholder="Enter Website URL" value="<?php echo (isset($blood_bank_data)) ? $blood_bank_data->help_line_no : ''; ?>">
                              </div>
                           </div>
                           <div class="row mb-3">
                              <label for="colFormLabel" class="col-sm-4 col-form-label">Have Blood Center</label>
                              <div class="col-sm-8">
                           ...
                           <div class="row mb-3">
                              <div class="col-md-3" id="components_div" style="display:<?php echo (isset($blood_bank_data) && ($blood_bank_data->component_facillity == 'yes')) ? 'block' : 'none'; ?>;">
                                 <?php
                                 if (!empty($components)) {

      ...
      <div class="row">
          ...
          <div class="contact-wrapper">
            ...
            <div class="">
             ...
             <div class="form-group" align="center">
              ...
              <button type="cancel"   class="col-md-5 btn btn-success btn-shik">Reset</button>
              <button type="submit"  class="col-md-5 btn btn-success  btn-shik">Filter</button>
             </div>
            </div>
          </form>
        ...
        <!-- table -->
            <table  class="table table-bordered table-hover">
             <thead>
              <tr>
                <th width="20%">book appointment</th>
    ...
    // die();
              ?>
                ...
                <tr>
                  ...
                  <td><span class="btn btn-success btn-shik2 book<?php echo $row->blood_bank_id; ?>" id="<?php echo $row->blood_bank_id; ?>"  >book</span></td>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div id="appo-details" class="">
            <div class="row">
              <label class="text-dark col-md-5 "><strong> Organization Name</strong> </label>:
              <span  class="text-dark col-md-5" id="bb-name"><?php echo $row->name; ?></span>
            </div>
            <!--  <div class="row">
             ...
             <div class="row">
              <label class="text-dark  col-md-5 "><strong> Organization Address</strong> </label>:
              <span  class="text-dark col-md-5" id="bb-addrs"><?php echo $row->address_1; ?></span>
            </div>
            
             <div class="row">
              <label class="text-dark col-md-5 "><strong> Appointment Date</strong> </label>:
        ...
        <div class="modal-footer p-1">
          <button type="button" id="closemodal" class="btn btn-secondary btn-shik3" data-dismiss="modal">Close</button>
          <button type="submit" name="submit" id="confirmBtn" name="organization_form" class="btn btn-primary btn-shik3" >Confirm</button>
        </div>
        </form>
      </div>

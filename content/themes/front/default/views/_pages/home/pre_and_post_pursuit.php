...
<section class="prepro-sec">

<h1 class="text-center" id="prepro-id">Pre and Post Process for Blood Donation</h1>
<hr class="prepro-hr">

<div class="prepro-box">
    <div class="pre-img">

<img src="<?php echo base_url('uploads/app/istockphoto-1338750217-612x612.jpg');?>" alt="">
...
<p>Eat some foods that have rich source of iron like dark green leafy vegetables, oats, tofu, and dried fruits.</p>

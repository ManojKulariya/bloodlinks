    ...
    $id = $_SESSION['customer_id'];
     $update = $this->db->query("UPDATE bl_blood_donation_requests SET requested_schedule_date = '$o_date', reason = '$o_reasion' WHERE id = '$o_id'");
          if($update == true){
          	...
          	echo '<script>alert("Your Appointment Reschedule successfully")</script>';
...
<div class="image-contactus-banner">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h1 class="lg-text text-dark">My Appointments</h1>
			...
			<div class="col-md-12">
				<div class="contact-wrapper">
					<header class="login-cta">
						<h2 id="current-tab">My Appointments</h2>
						<hr class="appointmenr-hr">
					</header>
					<div class="row">
		<!-- 				<br>
...
// updated_by	
                     ...
                     ?>
	                   ...
	                   <?php } ?>
      						...
      						<td><span class="btn new-red book<?php echo $row->id; ?>" id="<?php echo $row->id; ?>">Re-schedule</span>
      							</td>
      					</tr>
      					<!-- Modal -->

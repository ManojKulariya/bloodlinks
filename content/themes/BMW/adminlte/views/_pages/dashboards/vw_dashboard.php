                                            ...
                                            <div class="bg-white box-shadow border-radius-10 height-100-p widget-style3">
                                                <div class="d-flex flex-wrap">
                                                    <div class="widget-data">
                                                        <div class="weight-500 font-20">Total Request</div>
                                                        <div class="weight-500 font-30 text-dark"><?= $total_stock ?></div>
                                                    </div>
                                    ...
                                    <div class="col-xl-3 mb-50">
                                        <a href="#">
                                            ...
                                            <div class="bg-white box-shadow border-radius-10 height-100-p widget-style3">
                                                <div class="d-flex flex-wrap">
                                                    <div class="widget-data">
                                                        <div class="weight-500 font-20">Request Pending</div>
                                                        <div class="weight-500 font-30 text-dark"><?= $total_pending ?></div>
                                                    </div>
                                                    <div class="widget-icon">
                                    ...
                                    <div class="col-xl-3 mb-50">
                                        <a href="#">
                                            ...
                                            <div class="bg-white box-shadow border-radius-10 height-100-p widget-style3">
                                                <div class="d-flex flex-wrap">
                                                    <div class="widget-data">
                                                        <div class="weight-500 font-20">Request Complete</div>
                                                        <div class="weight-500 font-30 text-dark"><?= $total_reached ?></div>
                                                    </div>
                                                    <div class="widget-icon">
                                    ...
                                    <div class="col-xl-3 mb-50">
                                        <a href="#">
                                            <div class="bg-white box-shadow border-radius-10 height-100-p widget-style3">
                                                <div class="d-flex flex-wrap">
                                                    <div class="widget-data">
                                                        <div class="weight-500 font-20">Request Not Complete</div>
                                                        <div class="weight-500 font-30 text-dark"><?= $total_not_reached ?></div>
                                                    </div>
                                                    <div class="widget-icon">

...
<h6 style="text-align: center;line-height:1;"><?php echo ($bloodbank->name) ?><br> A UNIT OF VITA HEE CARE TRUST<br>
  <?php echo ($bloodbank->address_1) ?></br><span style="text-align: center;font-weight: bold;">Record for Consumable Items</span> </h6>
  
  <table style="border: 1px solid black;font-family: arial, sans-serif;border-collapse: collapse;width: 100%;font-size: 10px;">
    <tr>
      <th style="width: 11%;border: 1px solid black; text-align: center;" rowspan="2">Item Name</th>
      <th style="width: 11%;border: 1px solid black; text-align: center;" rowspan="2">Type</th>
      <th style="width: 11%;border: 1px solid black; text-align: center;" rowspan="2">Lot No.</th>
      <th style="width: 11%;border: 1px solid black; text-align: center;" rowspan="2">Manufacturer</th>
      <th style="width: 10%;border: 1px solid black; text-align: center;" rowspan="2">Manufacturing<br>Date</th>
      <th style="width: 10%;border: 1px solid black; text-align: center;" rowspan="2">Expiry<br>Date</th>
      <th style="width: 11%;border: 1px solid black; text-align: center;" rowspan="2">Received<br>Condition</th>
      <th style="width: 13%;border: 1px solid black; text-align: center;" colspan="2">Quantity</th>
      <th style="width: 11%;border: 1px solid black; text-align: center;" rowspan="2">Balance</th>
    </tr>
    <tr>
      <th style="width: 7%;border: 1px solid black; text-align: center;">Purchase</th>
      <th style="width: 6%;border: 1px solid black; text-align: center;">Issued</th>
    </tr>
    <?php foreach ($master_record as $ms) {    ?>
      <tr style="width: 100%;">
        <td style="border: 1px solid black; text-align: center;"><?= $ms['item_name'] ?></td>
        <td style="border: 1px solid black; text-align: center;"><?= $ms['consumable_type'] ?></td>
        <td style="border: 1px solid black; text-align: center;"><?= $ms['lot_no'] ?></td>
        ...
        <td style="border: 1px solid black; text-align: center;"><?= $ms['receive_condition'] ?></td>
        <td style="border: 1px solid black; text-align: center;"><?= $ms['qty_purchase'] ?></td>
        <td style="border: 1px solid black; text-align: center;"><?= $ms['qty_issued'] ?></td>
        <td style="border: 1px solid black; text-align: center;"><?= $ms['balance'] ?></td>

...
<h6 style="text-align: center;line-height:1;"><?php echo ($bloodbank->name) ?><br> A UNIT OF VITA HEE CARE TRUST<br>
  <?php echo ($bloodbank->address_1) ?></br><span style="text-align: center;font-weight: bold;">Register for Diagnostic Kits & Reagents Used</span> </h6>
  
  <table style="border: 1px solid black;font-family: arial, sans-serif;border-collapse: collapse;width: 100%;font-size: 10px;">
    <tr>
      <th style="width: 12%;border: 1px solid black; text-align: center;">Sr No.</th>
      <th style="width: 12%;border: 1px solid black; text-align: center;">Date of<br>Supply</th>
      <th style="width: 12%;border: 1px solid black; text-align: center;">Name of The Kits<br>& Reagents</th>
      <th style="width: 12%;border: 1px solid black; text-align: center;">Batch  No.</th>
      <th style="width: 12%;border: 1px solid black; text-align: center;">Manufacturer's<br>Name</th>
      <th style="width: 12%;border: 1px solid black; text-align: center;">Manufacturing<br>Date</th>
      <th style="width: 12%;border: 1px solid black; text-align: center;">Expiry<br>Date</th>
      <th style="width: 12%;border: 1px solid black; text-align: center;">Date of Use</th>
    </tr>
    <?php foreach ($master_record as $inx=>$ms) { ?>
      <tr style="width: 100%;">
        ...
        <td style="border: 1px solid black; text-align: center;"><?= $ms['hits_reagents'] ?></td>
        ...
        <td style="border: 1px solid black; text-align: center;"><?= $ms['date_use'] ?></td>
      </tr>
    <?php }  ?>
  </table>
  </div>

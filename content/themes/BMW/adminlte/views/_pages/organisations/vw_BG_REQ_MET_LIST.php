  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Total Request Met</h3>&nbsp;
        <a id="downloadmetReqexcel" href="#" style="text-decoration: underline; color: #0D2942;">Download
        Excel</a>

      </div>
      <!-- /.card-header -->
      <div class="card-body">
        <table id="table_req_met_bg" class="table table-bordered table-hover">
          <thead>
          <tr>
            <th>#</th>
            <th>Name</th>
            <th>Contact</th>
            <th>Component</th>
            <th>Demand Genrated by - Doctor/ Hospital</th>
          </tr>
          </thead>
          <tbody>
...
<script type="text/javascript">
  ...
  var bg_req_met_search_url='<?php echo $base_url;?>/bb_req_met_search';
  var bg_req_met_excel_search_url='<?php echo $base_url;?>/bb_req_met_search_excel';

  function reloadDataTable() {
    var table_req_met_bg = $('#table_req_met_bg').DataTable();
    var start_date = $('#start_date').val();
    var end_date = $('#end_date').val();
    table_req_met_bg.ajax.url(bg_req_met_search_url).draw();
  }
  function reset() {  
    location.reload();  
  }  

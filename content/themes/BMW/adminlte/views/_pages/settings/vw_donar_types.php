...
<div class="row">
  <div class="col-6">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Donar Types</h3>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
        <table id="table_donar_types" class="table table-bordered table-hover">
          <thead>
          <tr>
            <th>#</th>
            <th>Type Name</th>
  ...
  <div class="col-6">
    <div class="card">
      ...
      <!-- /.card-header -->
      <form role="form" id="form_donar_types">
        ...
        <div class="card-footer">
          <div class="btn-group" style="float: right;">
            <button type="submit" class="btn btn-sm btn-danger" id="btn_save_donar_types"><i class="fas fa-save fw"></i> Save</button>
          </div>
        </div>
      </form>
      <!-- /.card-body -->
               ...
               success:function(d){
                 // console.log (d);
                  if(d==1){
                     ...
                     $('#table_donar_types').DataTable().ajax.reload();
                  }
                  else{
                     alert('Delete Fail');
                  }

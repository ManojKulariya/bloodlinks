...
<div class="row">
  <div class="col-6">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Camp Codes</h3>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
        <table id="table_camp_codes" class="table table-bordered table-hover">
          <thead>
          <tr>
            <th>#</th>
            <th>Type Name</th>
  ...
  <div class="col-6">
    <div class="card">
      ...
      <!-- /.card-header -->
      <form role="form" id="form_camp_codes">
        <input type="hidden" name="masters_id" id="masters_id">
        <div class="card-body">
          <div class="form-group">
            <label for="masters_value">Type Name</label>
            <input type="text" class="form-control" id="masters_value" name="masters_value" placeholder="Enter camp code">
          </div>
          <div class="form-group">
        ...
        <div class="card-footer">
          <div class="btn-group" style="float: right;">
            <button type="submit" class="btn btn-sm btn-danger" id="btn_save_camp_codes"><i class="fas fa-save fw"></i> Save</button>
          </div>
        </div>
      </form>
      <!-- /.card-body -->
               ...
               success:function(d){
                 // console.log (d);
                  if(d==1){
                     ...
                     $('#table_camp_codes').DataTable().ajax.reload();
                  }
                  else{
                     alert('Delete Fail');
                  }

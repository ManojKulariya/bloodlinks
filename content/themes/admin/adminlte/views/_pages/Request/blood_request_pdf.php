...
<script type="text/javascript">
    window.print();
        ...
        <div class="div1" style="padding-top: 100px;">
            <h3 style="text-align: center;">Blood Bank</h3>
            <h3 style="text-align: center;">(Regional Blood Center)</h3>
            <p style="text-align: center">
                <?php echo ucwords($bloodbank->name);?>
            </p>
            <p style="text-align: center;"><?php echo ucwords($bloodbank->address_1 . "-". $bloodbank->pincode);?></p>
            <p style="text-align: center;">
        ...
        <div class="row">
            <div class="column" style="margin-top: 10px" >
                <table>
                    ...
                    <tr>
                        <td>Name of the hospital: <?=$request_form->hospital ?></td>
        ...
        <h3 style="width: 600px;">
            Clinical Information (Fill By clinician/Resident/Docter/Nurse)
        </h3>
        <div class="row">
            <div class="column" style="margin-top: 10px; width: 100%">
                <table>
                    <tr>
                        <th colspan="3">Clinical History :<?=$request_form->clinical_history ?></th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="3">Reason for transation :<?=$request_form->reasons ?></td>
                    </tr>
                    <tr>
                        <td>
                ...
                <table>
                    ...
                    <tr>
                       ...
                       <!--  <td>   <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike" style="margin-left: 10px;"></td> -->
                        ...
                        <td> <?=$form_data1->whole_blood_unit; ?></td>

                         <?php if(!empty($form_data1->whole_blood_unit)){ ?>
                        <td> <i class="fa"><?php if( $form_data2->whole_blood_test == "Yes"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?></i> Yes
                    <i class="fa"><?php if($form_data2->whole_blood_test == "No"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?></i> No
                        </td>

                        <?php }else{ ?>
                        	 <td> <i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i> Yes
                    <i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i> No
                        </td>
                       ...
                       <!--  <td>   <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike" style="margin-left: 10px;"></td> -->
                        ...
                        <td> <?=$form_data1->Cryo_Poor_Plasma_unit; ?></td>

                         <?php if(!empty($form_data1->Cryo_Poor_Plasma_unit)){ ?>
                        <td> <i class="fa"><?php if( $form_data2->Cryo_Poor_Plasma_test == "Yes"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?></i> Yes
                    <i class="fa"><?php if($form_data2->Cryo_Poor_Plasma_test == "No"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?></i> No
                        </td>
                    ...
                    <i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i> No
                       ...
                       <!--  <td>   <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike" style="margin-left: 10px;"></td> -->
                        ...
                        <td> <?=$form_data1->Cryoprecipitate_unit; ?></td>
                          <?php if(!empty($form_data1->Cryoprecipitate_unit)){ ?>
                        <td> <i class="fa"><?php if( $form_data2->Cryoprecipitate_test == "Yes"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?></i> Yes
                    <i class="fa"><?php if($form_data2->Cryoprecipitate_test == "No"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?></i> No
                        </td>
                         <?php }else{  ?>
                        	 <td> <i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i> Yes
                    <i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i> No
                       ...
                       <!--  <td>   <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike" style="margin-left: 10px;"></td> -->
                        ...
                        <td> <?=$form_data1->Fresh_Frozen_Plasma_unit; ?></td>
                           <?php if(!empty($form_data1->Fresh_Frozen_Plasma_unit)){ ?>
                        <td> <i class="fa"><?php if( $form_data2->Fresh_Frozen_Plasma_test == "Yes"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?></i> Yes 
                    <i class="fa"><?php if($form_data2->Fresh_Frozen_Plasma_test == "No"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?></i> No
                        </td>
                       <?php }else{  ?>
                        	 <td> <i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i> Yes
                    <i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i> No
                       ...
                       <!--  <td>   <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike" style="margin-left: 10px;"></td> -->
                        ...
                        <td> <?=$form_data1->Red_blood_cell_unit; ?></td>
                         <?php if(!empty($form_data1->Red_blood_cell_unit)){ ?>
                        <td> <i class="fa"><?php if( $form_data2->Red_blood_cell_test == "Yes"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?></i> Yes
                    <i class="fa"><?php if($form_data2->Red_blood_cell_test == "No"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?></i> No
                        </td>
                        <?php }else{  ?>
                        	 <td> <i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"> </i>Yes 
                    <i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i> No
                       ...
                       <!--  <td>   <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike" style="margin-left: 10px;"></td> -->
                        ...
                        <td> <?=$form_data1->Platelet_rich_concentrate_unit; ?></td>
                            <?php if(!empty($form_data1->Platelet_rich_concentrate_unit)){ ?>
                        <td> <i class="fa"><?php if( $form_data2->Platelet_rich_concentrate_test == "Yes"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?></i> Yes 
                    <i class="fa"><?php if($form_data2->Platelet_rich_concentrate_test == "No"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?></i> No
                        </td>
                       <?php }else{  ?>
                        	 <td> <i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i> Yes 
                    <i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i> No
        ...
        <div class="row">
            <div class="column" style="margin-top: 10px; width: 100%; ">
                    ...
                    <tr>
                        <td style="width:290px;">
                            ...
                            <label class="form-check-label" for="flexCheckDefault">
                                STAT    <?php if( $request_form->stat == "false"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?>&nbsp;&nbsp;<br>(Within 15 mins)
                            </label>
                        ...
                        <td style="width:290px;">
                            ...
                            <label class="form-check-label" for="flexCheckDefault">
                                Urgent    <?php if( $request_form->urgent == "false"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?>&nbsp;&nbsp;<br>(one hours)
                            </label>
                        </td>
                        <td style="width:290px;">
                            <label class="form-check-label" for="flexCheckDefault">
                                Routine   <?php if( $request_form->routine == "false"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?>&nbsp;&nbsp;
                            </label>
                        </td>
                        <td>
                            <label class="form-check-label" for="flexCheckDefault">
                                Reserved   <?php if( $request_form->reserved == "false"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?>&nbsp;&nbsp;
                            </label>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4" style="border-bottom:none;">If Urgently Stat Required Please Specify Person
                            <span
              ...
              border-left: none;">
                        ...
                        <td style="
              border-top: none;
              border-left: none;">Name and signature of medical officer (with stamp)</td>
                ...
                <table id="class">
                    ...
                    <tr>
                        <td colspan="2" style="border: none;">
                            ...
                            <label class="form-check-label" for="flexCheckDefault">
                              <?php if( $request_form->patient == "false"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?>&nbsp;&nbsp;  Patient (if concious) confirms to his and father's name
                            </label>
                        ...
                        <td colspan="2">
                            ...
                            <label class="form-check-label" for="flexCheckDefault">
                              <?php if( $request_form->sample == "false"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?>&nbsp;&nbsp;  Sample tube cames the patient's name, reg No ward
                            </label>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <label class="form-check-label" for="flexCheckDefault">
                              <?php if( $request_form->identity == "false"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?>&nbsp;&nbsp; If unconscious Relative(s)/Staff confirm the identity
                            </label>
                        ...
                        <td colspan="2">
                            ...
                            <label class="form-check-label" for="flexCheckDefault">
                             <?php if( $request_form->matchs == "false"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?>&nbsp;&nbsp;  That Match with the medical records
                            </label>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <label class="form-check-label" for="flexCheckDefault">
                             <?php if( $request_form->medical == "false"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?>&nbsp;&nbsp;  The identity,Reg No. check with the medical records and <br> same is written on the requisition form 
                            </label>
                        ...
                        <td colspan="2">
                            ...
                            <label class="form-check-label" for="flexCheckDefault">
                              <?php if( $request_form->sample_tube == "false"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?>&nbsp;&nbsp;  Phlebatomist has signed the sample tube
                            </label>
                    ...
                    <tr>
                        <td colspan="4">
                            ...
                            <label class="form-check-label" for="flexCheckDefault">
                              <?php if( $request_form->completely == "false"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?>&nbsp;&nbsp;  Patient (if concious) confirms to his and father's name
                            </label>
...
<td></td>
    ...
    <!-- </div> -->
        ...
        <div class="col7">
            ...
            <p>The patient is unable to give consent because............................................................................................................................................and I.....................................................................................................<br>.............................................................................(name/relationship to patient), therefore consent for the patient. I acknowledge that I have been an opportunity to discuss this procedure, as stated above, with my physician, physician designee and hereby consent to this procedure.</p>

...
<?php 
 ...
 function get_com($comp){
   ...
   //    } 
      ...
      $query3 = $this->db->query("SELECT * FROM bl_crossmatch WHERE bloodbank_id = '$bank_id' and id = '$id'");
...
<div class="constant" style="width:100%;border: 2px solid black;">
   <div class="header">
      <div class="header1" >
   ...
   <p style="text-align: center;font-size: 12px;width:345px;">
      <?php echo($bloodbank->address_1) ?>
      <!--Ph: <?php echo($bloodbank->contact_ph_no) ?>-->
   </p>
   <div class="field">
   ...
   <div class="container1">
      ...
      <table>
         ...
         <tr>
            <td><?php 
            $res = get_com($bl_crossmatch->component);
            echo($res) ?></td>

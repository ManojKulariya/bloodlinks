      ...
      <tbody>
        ...
        if (!empty($_POST)) {
          ...
          if (!empty($collection_date) && !empty($qc_id) && !empty($unit_no) && !empty($expiry) && (!empty($start_date) && !empty($end_date))) {
            ...
            $query = $this->db->query("SELECT * FROM bl_qc_component WHERE bl_qc_component.qc_date BETWEEN '$start_date' AND '$end_date' AND bl_qc_component.collection_date = '$collection_date' And bl_qc_component.expiry_date = '$expiry' And bl_qc_component.unit_no = '$unit_no' And bl_qc_component.qc_id = '$qc_id' ORDER BY ID DESC");
          } else {
            ...
            $query = $this->db->query("SELECT * FROM bl_qc_component  WHERE $search ORDER BY ID DESC");
          }
        } else {
          $query = $this->db->query("SELECT * FROM bl_qc_component ORDER BY ID DESC");
        }
        ...
        ?>
          ...
          <tr>
            ...
            <td class="capitalize"><?= $row->anti ?></td>
            ...
            <td class="capitalize"><?= $row->ptt ?></td>
            <td class="capitalize"><?= $row->frbrinogen ?></td>
            <td class="capitalize"><?= $row->factor ?></td>

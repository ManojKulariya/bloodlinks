...
if(!empty($_POST['blood_name'])){
    ...
    $update = $this->db->query("UPDATE bl_bloodcamp SET blood_name = '$blood_name' , camp_code = '$camp_code' , start_date = '$start_date' , end_date = '$end_date' , venue = '$venue' , sponsored = '$sponsored' , address = '$address' , mobile = '$mobile' , latitude = '$latitude' , longitude = '$longitude' , state = '$state' , city = '$city' ,expected_no ='$expected_no' ,permission ='$permission' , start_time = '$start_time' , end_time = '$end_time'  WHERE id = '$id'");

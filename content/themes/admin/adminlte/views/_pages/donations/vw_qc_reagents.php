          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="date" class="form-control" id="price" name="date" value="<?php if(isset($_POST) && isset($_POST['date'])){ echo $_POST['date']; } ?>">
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="price" name="reagent" value="<?php if(isset($_POST) && isset($_POST['reagent'])){ echo $_POST['reagent']; } ?>">
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="price" name="lot_no" value="<?php if(isset($_POST) && isset($_POST['lot_no'])){ echo $_POST['lot_no']; } ?>">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="date" class="form-control" id="price" name="manufactures_date" value="<?php if(isset($_POST) && isset($_POST['manufactures_date'])){ echo $_POST['manufactures_date']; } ?>">
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                <label for="price">Expiry Date</label>
                <input type="date" class="form-control" id="price" name="expiry_date" value="<?php if(isset($_POST) && isset($_POST['expiry_date'])){ echo $_POST['expiry_date']; } ?>">
    ...
    <table class="table table-fluid" id="myTable">
      ...
      <tbody>
        ...
        if (!empty($_POST)) {
          ...
          if (!empty($date) && !empty($reagent) && !empty($lot_no) && !empty($manufactures_date) && !empty($expiry_date)) {

            $query = $this->db->query("SELECT * FROM bl_qc_reagents WHERE bl_qc_reagents.bloodbank_id = '$bank_id' And bl_qc_reagents.date = '$date' And bl_qc_reagents.name_reagent = '$reagent' And bl_qc_reagents.lot_no = '$lot_no' And bl_qc_reagents.manufactures_date = '$manufactures_date' And bl_qc_reagents.expiry = '$expiry_date' ORDER BY ID DESC");
          } else {
$search='';
            if (!empty($date)) {
              if(!empty( $search)) {
			...
			if (!empty($lot_no)) {
              ...
              $search .= "bl_qc_reagents.lot_no = '$lot_no'";
            } 
			if (!empty($manufactures_date)) {
              if(!empty( $search)) {
						 $search .=' And ';
					}
              $search .= "bl_qc_reagents.manufactures_date = '$manufactures_date'";
            } 
...
$querySearch='';
            ...
            $query = $this->db->query("SELECT * FROM bl_qc_reagents  WHERE bl_qc_reagents.bloodbank_id = '$bank_id'  $querySearch ORDER BY ID DESC");
          }
        } else {
          $query = $this->db->query("SELECT * FROM bl_qc_reagents  WHERE bl_qc_reagents.bloodbank_id = '$bank_id' ORDER BY ID DESC");
        }
        ...
        ?>
          ...
          <tr>
            ...
            ?>
                <td><?php echo '<a href="' . $this->data['base_url'] . '/donations/qc_reagents/edit/' . $row->id . '" class="btn btn-xs btn-danger btn_edit_data" data-master_id="" data-master_type="" data-master_type_value=""><i class="fa fa-pen"></i></a>  <button type="button" class="btn btn-xs btn-dark" onclick="deleteFun(' . $row->id . ');" ><i class="fa fa-trash"></i></button>'; ?></td>
              <?php }
            } else { ?>
              <td><?php echo '<a href="' . $this->data['base_url'] . '/donations/qc_reagents/edit/' . $row->id . '" class="btn btn-xs btn-danger btn_edit_data" data-master_id="" data-master_type="" data-master_type_value=""><i class="fa fa-pen"></i></a>  <button type="button" class="btn btn-xs btn-dark" onclick="deleteFun(' . $row->id . ');" ><i class="fa fa-trash"></i></button>'; ?></td>
            <?php } ?>
    ...
    function deleteFun(id) {
      ...
      if (confirm('Are you sure') == true) {
        ...
        $.ajax({
          ...
          url: '<?php echo $base_url; ?>/donations/qc_reagents_delete',
          method: "POST",
          datatype: "json",
          data: {
            [csrf_name]: csrf_hash,

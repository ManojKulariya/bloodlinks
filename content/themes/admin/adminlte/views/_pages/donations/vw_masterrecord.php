...
<div class="container" id="printPageButton">
  <form action = "<?php $_PHP_SELF ?>" method = "POST">
    ...
    <div class="timeline">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="price" name="start_id" value="<?php if(isset($_POST) && isset($_POST['start_id'])){ echo $_POST['start_id']; } ?>">
                      </div>
                    </div>
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="price" name="end_id" value="<?php if(isset($_POST) && isset($_POST['end_id'])){ echo $_POST['end_id']; } ?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="price" name="unit_from" value="<?php if(isset($_POST) && isset($_POST['unit_from'])){ echo $_POST['unit_from']; } ?>">
                      </div>
                    </div>
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="price" name="unit_to" value="<?php if(isset($_POST) && isset($_POST['unit_to'])){ echo $_POST['unit_to']; } ?>">
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        <label for="description">Request No (From)</label>
                        <input type="text" class="form-control" id="price" name="request_from" value="<?php if(isset($_POST) && isset($_POST['request_from'])){ echo $_POST['request_from']; } ?>">
                      </div>
                    </div>
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="price" name="request_to" value="<?php if(isset($_POST) && isset($_POST['request_to'])){ echo $_POST['request_to']; } ?>">
                      </div>
                    </div>
          ...
          <br>
          <div>
          <h4 style="text-align: center;"><?php echo($bloodbank->name) ?></h4>
         ...
         //print_r($_POST); die;
           ...
           if (!empty($name) && (!empty($unit_from) && !empty($unit_to)) && (!empty($request_from) && !empty($request_to)) && (!empty($start_id) && !empty($end_id)) && (!empty($start_date) && !empty($end_date))) {
            ...
            $query = $this->db->query("SELECT bl_bb_donatioform.*, bl_blood_record.* FROM bl_blood_record LEFT JOIN bl_bb_donatioform ON 
            bl_blood_record.donor_unit_no = bl_bb_donatioform.unit_no WHERE bl_blood_record.bloodbank_id = '$bank_id' And bl_bb_donatioform.donor_name = '$name' 
            And bl_bb_donatioform.created_at BETWEEN '$start_date' AND '$end_date' And bl_bb_donatioform.id BETWEEN '$start_id' AND '$end_id' And bl_bb_donatioform.unit_no BETWEEN '$unit_to' AND '$unit_from' And bl_bb_donatioform.registration_no BETWEEN '$request_to' AND '$request_from'");
...
$search='';
            if(!empty($name)){
              ...
              $search .= "bl_bb_donatioform.donor_name LIKE '%$name%'";
            }
			if(!empty($start_date) && empty($end_date)){
              if(!empty( $search)) {
						 $search .=' And ';
					}
              $search .= "bl_bb_donatioform.created_at = '$start_date'";
            }
			...
			if(empty($start_date) && !empty($end_date)){
              ...
              $search .= "bl_bb_donatioform.created_at = '$end_date'";
            }if(!empty($start_date) && !empty($end_date)){
              if(!empty( $search)) {
						 $search .=' And ';
					}
			...
			if(!empty($unit_from) && !empty($unit_to)){
              if(!empty( $search)) {
						 $search .=' And ';
					}
            ...
            $query = $this->db->query("SELECT bl_bb_donatioform.*, bl_blood_record.* FROM bl_blood_record LEFT JOIN bl_bb_donatioform 
            ON bl_blood_record.donor_unit_no = bl_bb_donatioform.unit_no WHERE bl_blood_record.bloodbank_id = '$bank_id' $querySearch");

          }
        }else{
         $query = $this->db->query("SELECT bl_bb_donatioform.*, bl_blood_record.* FROM bl_blood_record LEFT JOIN bl_bb_donatioform 
         ON bl_blood_record.donor_unit_no = bl_bb_donatioform.unit_no WHERE bl_blood_record.bloodbank_id = '$bank_id'"); }
          ...
          <table>
            ...
            <tr >
              ...
              <td rowspan="5">
               <table>
                   <?php
                   if($row->blood_from_bank != null){
                        $this->db->from("bl_agency"); 
                        $this->db->where('id',$row->blood_from_bank);
                        $bloodbank = $this->db->get()->row();
                        if($bloodbank){
                            $donor_name =$bloodbank->a_name.'<br><strong>'.$row->old_unit_no.'</strong>';
                   ...
                   ?>
                <tr>
                  <td  id="tab" style="border-top: none;border-right: none; border-left:none;"><?=$donor_name ?></td>
                </tr>
                <tr>
                  <td id="tab" style="border-right: none; border-left:none; border-bottom:none !important;"><?=$address ?></td>
                </tr>
                <tr>
         ...
         <td rowspan="5">
          <table>
           ...
           <tr>
             ...
             border-left: none;"><?=$row->hemoglobin ?></td>

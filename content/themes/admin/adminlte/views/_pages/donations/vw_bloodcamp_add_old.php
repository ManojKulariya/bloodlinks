...
if(!empty($_POST['camp_name'])){
   ...
   $latitude = $_POST['latitude'];
    ...
    $insert = $this->db->query("INSERT INTO bl_bloodcamp (bloodbank_id, blood_name, camp_code, camp_type, start_date, end_date,  venue, sponsored, address, mobile ,latitude ,longitude, state, city , status, start_time, end_time, permission, expected_no) VALUES ( '$bank_id' , '$camp_name' , '$blood_campno' , '$camp_code' , '$start_date', '$end_date' , '$venue' , '$sponsored' , '$address' , '$mobile' ,'$latitude','$longitude', '$state' , '$city' , '1' , '$start_time','$end_time' ,'$permission','$expected_no')");

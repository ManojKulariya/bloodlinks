...
<br> -->
   ...
   <form action="<?php $_PHP_SELF ?>" method="POST" class="msform">
      <fieldset>
         <!--1st step -->
         <div class="form-card">
            <div class="row">
            ...
            <div class="row">
               ...
               <div class="col-md-12 well_feeling_div today msg">
                  ...
                  <div class="pre-question">
                     <div class="buttons">
                        <ul>
                           <li>
                              <label class="rad-label">
                                 <input type="radio" class="rad-input" name="well_feeling" value="yes" <?php echo (!empty($form_data) && isset($today->well_feeling) && ($today->well_feeling == 'yes')) ? 'checked="checked"' : ''; ?>>
                                 <div class="rad-design"></div>
                           ...
                           <li>
                              <label class="rad-label">
                                 <input type="radio" class="rad-input" name="well_feeling" value="no" <?php echo (!empty($form_data) && isset($today->well_feeling) && ($today->well_feeling == 'no')) ? 'checked="checked"' : (empty($form_data) ? 'checked="checked"' : ''); ?>>
                                 <div class="rad-design"></div>
                  ...
                  <div class="pre-question">
                     <div class="buttons">
                        <ul>
                           <li>
                              <label class="rad-label">
                                 <input type="radio" class="rad-input" name="fed_in_last_4_hrs" value="yes" <?php echo (!empty($form_data) && isset($today->fed_in_last_4_hrs) && ($today->fed_in_last_4_hrs == 'yes')) ? 'checked="checked"' : ''; ?>>
                                 <div class="rad-design"></div>
                                 <div class="rad-text">Yes</div>
                              </label>
                           </li>
                           <li>
                              <label class="rad-label">
                                 <input type="radio" class="rad-input" name="fed_in_last_4_hrs" value="no" <?php echo (!empty($form_data) && isset($today->fed_in_last_4_hrs) && ($today->fed_in_last_4_hrs == 'no')) ? 'checked="checked"' : (empty($form_data) ? 'checked="checked"' : ''); ?>>
                                 <div class="rad-design"></div>
                                 <div class="rad-text">No</div>
                              </label>
                           </li>
                  ...
                  <div class="pre-question">
                     <div class="buttons">
                        <ul>
                           <li>
                              <label class="rad-label">
                                 <input type="radio" class="rad-input" name="well_slept_last_night" value="yes" <?php echo (!empty($form_data) && isset($today->well_slept_last_night) && ($today->well_slept_last_night == 'yes')) ? 'checked="checked"' : ''; ?>>
                                 <div class="rad-design"></div>
                                 <div class="rad-text">Yes</div>
                              </label>
                           </li>
                           <li>
                              <label class="rad-label">
                                 <input type="radio" class="rad-input" name="well_slept_last_night" value="no" <?php echo (!empty($form_data) && isset($today->well_slept_last_night) && ($today->well_slept_last_night == 'no')) ? 'checked="checked"' : (empty($form_data) ? 'checked="checked"' : ''); ?>>
                                 <div class="rad-design"></div>
                                 <div class="rad-text">No</div>
                              </label>
                           </li>
               ...
               <!-------->
               <div class="col-md-12 other_day msg yes msg">
                  <label class="fieldlabels"><span class="number-span">◉</span> Have you donated blood previously ?</label>
                  <div class="pre-question">
                     <div class="buttons">
                        <ul>
                           <li>
               ...
               <div class="col-md-12 yes msg">
                  <div class="row" style="padding-left: 50px;padding-right: 50px;padding-bottom: 50px;">
                     <div class="col-md-3">
                        <label class="fieldlabels">When Last </label>
                        <input type="text" name="prev_donation_date" placeholder="Date of Admission" id="last_blood_donation" value="<?php echo (!empty($form_data) && isset($form_data->has_prev_donation->ans_data->prev_donation_date)) ? $form_data->has_prev_donation->ans_data->prev_donation_date : ''; ?>" />
                     </div>
                     <div class="col-md-12">
               ...
               <!-------->
               <div class="col-md-12 other_day msg yes msg">
                  <label class="fieldlabels"><span class="number-span">◉</span> Have You Any Reason To Believe That Donation Shall Infect You ?</label>
                  <div class="pre-question">
                     <div class="buttons">
                        <ul>
                           <li>
               ...
               <!------->
               <div class="col-md-12 other_day msg yes msg">
                  <label class="fieldlabels"><span class="number-span">◉</span> Are You Suffering From :</label>
                  <div class="pre-question">
                     <div class="buttons">
                        <ul>
                           <li>
               ...
               <!------->
               <div class="col-md-12">
                  <label class="fieldlabels"><span class="number-span">2.</span> Have You Taking Or Have Taken Medicine In Last 72 Hours Any Of The Following:</label>
                  <div class="pre-question">
                     <div class="buttons">
                        <ul>
                           <li>
               ...
               <!------->
               <div class="col-md-12">
                  <label class="fieldlabels"><span class="number-span">3.</span> In The Last 2 Weeks Have You Been Vaccinated/Immunized For Any Of The Following</label>
                  <div class="pre-question">
                     <div class="buttons">
                        <ul>
                           <li>
               ...
               <!------->
               <div class="col-md-12">
                  <label class="fieldlabels"><span class="number-span">4.</span> In The Last 2 Weeks Did You Suffer From Any Of The Following Diseases</label>
                  <div class="pre-question">
                     <div class="buttons">
                        <ul>
                           <li>
               ...
               <!------->
               <div class="col-md-12">
                  <label class="fieldlabels"><span class="number-span">5.</span> In The Last 3 Months Have You Had Any Of The Following :</label>
                  <div class="pre-question">
                     <div class="buttons">
                        <ul>
                           <li>
               ...
               <!------->
               <div class="col-md-12">
                  <label class="fieldlabels"><span class="number-span">6.</span> In The Last 6 Months Have You Had Any Of The Following :</label>
                  <div class="pre-question">
                     <div class="buttons">
                        <ul>
                           <li>
               ...
               <!------->
               <div class="col-md-12">
                  <label class="fieldlabels"><span class="number-span">7.</span> In The Last 12 Months Have You Had Any Of The Following :</label>
                  <div class="pre-question">
                     <div class="buttons">
                        <ul>
                           <li>
               ...
               <!------->
               <div class="col-md-12">
                  <label class="fieldlabels"><span class="number-span">8.</span> Have You Ever Had Any Of The Following (Permanent Defer) :</label>
                  <div class="pre-question">
                     <div class="buttons">
                        <ul>
                           <li>
         ...
         <a type="submit" href="<?php echo base_url('admin/donations/donation_form2/' . $id . '/' . $userid . ''); ?>" class="btn btn-success btn-md pull-right" type="button" />Next</a>
   ...
   // // print_r($new_details);die();
   // $update = $this->db->query("UPDATE bl_donar_form_info SET detail = '$new_details'  WHERE form_id = '$id' AND form_step = 'step_1'");
   //  if($update==true){
   //     redirect('admin/donations/donation_form2/'.$id.'');
   //   } else{
   //   echo "fail";
   //   }
   // }
   ?>
   <script type="text/javascript" src="http://bloodlinks.in/admin/v3/content/themes/front/default/assets/dist/js/jquery.min.js"></script>
   <script type="text/javascript" src="http://bloodlinks.in/admin/v3/content/themes/front/default/assets/dist/js/bootstrap.min.js"></script>
   <script type="text/javascript" src="http://bloodlinks.in/admin/v3/content/themes/front/default/assets/dist/js/jquery.meanmenu.js"></script>
   <script type="text/javascript" src="http://bloodlinks.in/admin/v3/content/themes/front/default/assets/dist/js/jquery.nice-select.min.js"></script>
   <script type="text/javascript" src="http://bloodlinks.in/admin/v3/content/themes/front/default/assets/cdnjs.cloudflare.com/ajax/libs/superfish/1.7.4/superfish.min.js"></script>
   <script type="text/javascript" src="http://bloodlinks.in/admin/v3/content/themes/front/default/assets/dist/js/custom.js"></script>
   <script type="text/javascript" src="http://bloodlinks.in/admin/v3/content/themes/front/default/assets/dist/js/slick.min.js"></script>
   <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.9.0/js/bootstrap-datepicker.min.js"></script>
   <script type="text/javascript" src="http://bloodlinks.in/admin/v3/content/themes/front/default/assets/dist/js/jquery-validation/jquery.validate.min.js"></script>
   <script type="text/javascript" src="http://bloodlinks.in/admin/v3/content/themes/front/default/assets/dist/js/jquery-validation/additional-methods.min.js"></script>
   <script type="text/javascript" src="http://bloodlinks.in/admin/v3/content/themes/front/default/assets/scripts/common.js"></script>
   <script type="text/javascript" src="http://bloodlinks.in/admin/v3/content/themes/front/default/assets/scripts/donation_request.js"></script>

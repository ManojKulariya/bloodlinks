...
<form id="form_step_2" class="msform">
   <fieldset>
      ...
      <!-- <a href="<?php echo base_url('admin/donations/donation_form2');?>" class="next action-button" type="button"/>Next</a> -->
     <a href="<?php echo base_url('admin/donations/donation_form3/'.$id.'/'.$userid.'');?>"  class="btn btn-success btn-md pull-right" type="button"/>Next</a>
   </fieldset>
   <!--2nd step tab end-->
</form>
<?php } ?>

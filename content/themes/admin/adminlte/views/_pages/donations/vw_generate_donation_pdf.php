...
$
$id= $this->uri->segment(4);
 $query7 = $this->db->query("SELECT * FROM bl_donar_form_info WHERE form_id = '$id' And form_step = 'step_5'");
 //print_r(json_encode($query));
...
// print_r($id);die();;
 ...
 // echo $this->db->last_query();die   // print_r($query6->result());
...
<p style="margin-bottom: 0rem !important;"> 
    Weight&nbsp; : &nbsp;<?php echo $form_data4->weight; ?>(Kg) 
    Temperature&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;
   <?php if( $form_data4->temperature == "normal"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?>&nbsp;&nbsp;
    Afebrile&nbsp;&nbsp;
   <?php if(  $form_data4->temperature == "no"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?>&nbsp;&nbsp;
    febrile&nbsp;&nbsp;
    Haemoglobin&nbsp;:&nbsp;<?php echo $form_data4->hemoglobin ?>&nbsp;gm/dl 
    BP&nbsp;:&nbsp;<?php echo $form_data4->BP ?>&nbsp;mm Hg&nbsp;&nbsp;&nbsp;
    Pulse  &nbsp;:&nbsp;
   <?php if($form_data4->pulse == "normal"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?>&nbsp;&nbsp;
    Regular&nbsp;&nbsp;
   <?php if( $form_data4->pulse == "no"){?><i class="fa fa-check-square" aria-hidden="true" ></i><?php }else{?><i class="fa fa-square" aria-hidden="true" style="font-weight: normal;"></i><?php } ?>&nbsp;&nbsp;
    Irregular&nbsp;&nbsp;
    </p>

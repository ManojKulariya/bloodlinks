...
<div class="row">
  <div class="col-6">
    <div class="card">
      ...
      <!-- /.card-header -->
      <div class="card-body">
        <table id="table_ttl_types" class="table table-bordered table-hover">
          <thead>
          <tr>
            <th>#</th>
            <th>Type Name</th>
  ...
  <div class="col-6">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">TTL Types</h3>
      </div>
      <!-- /.card-header -->
      <form role="form" id="form_ttl_types">
        ...
        <div class="card-footer">
          <div class="btn-group" style="float: right;">
            <button type="submit" class="btn btn-sm btn-danger" id="btn_save_ttl_types"><i class="fas fa-save fw"></i> Save</button>
          </div>
        </div>
      </form>
      <!-- /.card-body -->

...
<div class="row">
  <div class="col-6">
    <div class="card">
      ...
      <!-- /.card-header -->
      <div class="card-body">
        <table id="table_districts" class="table table-bordered table-hover">
          <thead>
          <tr>
            <th>#</th>
            <th>Name</th>
  ...
  <div class="col-6">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">District Data</h3>
      </div>
      <!-- /.card-header -->
      <form role="form" id="form_bag_types">
        ...
        <div class="card-body">
          <div class="form-group">
            <label for="masters_value">District Name</label>
...
<script type="text/javascript">
  var district_search_url='<?php echo $base_url;?>/settings/districts_search';
</script>
<script type="text/javascript">
               ...
               success:function(d){
                 // console.log (d);
                  if(d==1){
                     ...
                     $('#table_districts').DataTable().ajax.reload();
                  }
                  else{
                     alert('Delete Fail');
                  }

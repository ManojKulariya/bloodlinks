...
<div class="row">
  <div class="col-6">
    <div class="card">
      ...
      <!-- /.card-header -->
      <div class="card-body">
        <table id="table_blood_groups" class="table table-bordered table-hover">
          <thead>
          <tr>
            <th>#</th>
            <th>Group Name</th>
      ...
      <form role="form" id="form_bag_types">
        ...
        <div class="card-body">
          <div class="form-group">
            <label for="masters_value">Group Name</label>
            <input type="text" class="form-control" id="masters_value" name="masters_value" placeholder="Enter blood group name">
          </div>
          <div class="form-group">
            <label for="maters_status">Status</label>
            <select class="form-control" name="maters_status">
        ...
        <div class="card-footer">
          <div class="btn-group" style="float: right;">
            <button type="submit" class="btn btn-sm btn-danger" id="btn_save_blood_groups"><i class="fas fa-save fw"></i> Save</button>
          </div>
        </div>
      </form>
      <!-- /.card-body -->
               ...
               success:function(d){
                 // console.log (d);
                  if(d==1){
                     ...
                     $('#table_blood_groups').DataTable().ajax.reload();
                  }
                  else{
                     alert('Delete Fail');
                  }

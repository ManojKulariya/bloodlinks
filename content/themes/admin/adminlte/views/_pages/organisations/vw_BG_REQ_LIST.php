        ...
        <div class="timeline">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-md-3">
                            <div class="form-group">
                                <label for="blood_group">Component</label>
                                <select name="component" id="component" class="form-control">
                                    <option  selected="selected" value="">Select</option>
                                    <option value="18">Whole Blood</option>
                                    <option value="22">PRC/ Packed Cell</option>
                                    <option value="21">RDP/SDP</option>
                                    <option value="20">FFP/Plasma</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-2">
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Pending Request For Blood</h3>&nbsp;
      ...
      <!-- /.card-header -->
      <div class="card-body">
        <table id="table_req_bg" class="table table-bordered table-hover">
          <thead>
          <tr>
            <th>#</th>
            <th>Name</th>
...
<script type="text/javascript">
  ...
  var bg_req_search_url='<?php echo $base_url;?>/bb_req_search';
  var bg_req_search_excel_url='<?php echo $base_url;?>/bb_req_search_excel';
  function reloadDataTable() {
    var table_req_bg = $('#table_req_bg').DataTable();
    var start_date = $('#start_date').val();
    var end_date = $('#end_date').val();
    table_req_bg.ajax.url(bg_req_search_url).draw();
  }
  function reset() {  
    location.reload();  
  }  

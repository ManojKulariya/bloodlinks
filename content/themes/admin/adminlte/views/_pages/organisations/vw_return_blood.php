          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="price" name="return_no" value="<?php if (isset($_POST) && isset($_POST['return_no'])) {
                                                                                              echo $_POST['return_no'];
                                                                                            } ?>">
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="price" name="reason" value="<?php if (isset($_POST) && isset($_POST['reason'])) {
                                                                                          echo $_POST['reason'];
                                                                                        } ?>">
                <input type="hidden" class="form-control" value="123" id="price" name="data">
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
...
<?php } ?> -->
      ...
      <tbody>
        ...
        if (!empty($_POST['data'])) {
          ...
          if (
            !empty($name) && !empty($issue_no) && !empty($request) && !empty($Component)
            && !empty($blood_group) && !empty($user) && (!empty($start_date) && !empty($end_date))
          ) {

            $query = $this->db->query("SELECT bl_crossmatch.*, bl_blood_banks.name , bl_blood_banks.blood_bank_id , bl_cities.city_name FROM bl_crossmatch INNER JOIN bl_blood_banks ON bl_blood_banks.blood_bank_id = bl_crossmatch.bloodbank_id INNER JOIN bl_cities ON bl_cities.id = bl_blood_banks.city_id WHERE created_at BETWEEN '$start_date' AND '$end_date' And bl_crossmatch.status = 'return' And bl_crossmatch.p_name = '$name' And bl_crossmatch.return_no = '$return_no' And bl_crossmatch.blood_group = '$blood_group' And bl_crossmatch.request = '$request' And bl_crossmatch.component = '$Component' And bl_crossmatch.reason_return = '$reason' AND bl_crossmatch.return_by = '$user'And bl_blood_banks.name = '$blood_bank' ORDER BY ID DESC");
          } else {
            $search = '';
            if (!empty($name)) {
              if (!empty($search)) {
            ...
            if (!empty($return_no)) {
              ...
              $search .= "bl_crossmatch.return_no = '$return_no'";
            }
            if (!empty($request)) {
              if (!empty($search)) {
                $search .= ' And ';
            ...
            if (!empty($reason)) {
              ...
              $search .= "bl_crossmatch.reason_return = '$reason'";
            }
            if (!empty($user)) {
              if (!empty($search)) {
                $search .= ' And ';
              }
              $search .= "bl_crossmatch.return_by = '$user'";
            }
            if (!empty($blood_bank)) {
              if (!empty($search)) {
                $search .= ' And ';
            ...
            $query = $this->db->query("SELECT bl_crossmatch.*, bl_blood_banks.name , bl_blood_banks.blood_bank_id , bl_cities.city_name FROM bl_crossmatch INNER JOIN bl_blood_banks ON bl_blood_banks.blood_bank_id = bl_crossmatch.bloodbank_id INNER JOIN bl_cities ON bl_cities.id = bl_blood_banks.city_id WHERE bl_crossmatch.status = 'return' $querySearch ORDER BY ID DESC");
          }
        } else {
          $query = $this->db->query("SELECT bl_crossmatch.*, bl_blood_banks.name , bl_blood_banks.blood_bank_id , bl_cities.city_name FROM bl_crossmatch INNER JOIN bl_blood_banks ON bl_blood_banks.blood_bank_id = bl_crossmatch.bloodbank_id INNER JOIN bl_cities ON bl_cities.id = bl_blood_banks.city_id WHERE bl_crossmatch.status = 'return' ORDER BY ID DESC");
        }

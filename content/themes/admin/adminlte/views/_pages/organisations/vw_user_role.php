...
if(isset($_POST['submit'])){
 ...
 //print_r($_POST); die;
  ...
  $insert = $this->db->query("INSERT INTO bl_bloodbank_master (bloodbank_id , master_type_name, master_type_key, master_type_key_value, master_type_key_status ) VALUES ( '0','$masters_type' , '$master_type_key' , '$type_name', '$masters_status' )");
  ...
  <div class="col-6">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Superadmin User Role</h3>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
...
<script type="text/javascript">
  var apppointment_search='<?php echo $base_url;?>/user_role_search';
</script>
<script type="text/javascript">
...
// alert(id);
    ...
    { 
      ...
      $.ajax({
               ...
               url:'<?php echo $base_url;?>/user_role_delete',
               method:"POST",
               datatype:"json",

            ...
            <div class="col-12 mb-3">
                  <div class="cards">
                     <div class="card-headers">
                        <b>Deferred Donors</b> &nbsp;
                        <a id="downloaddonorexcelLink" href="#" style="text-decoration: underline; color: #0D2942;">Download
                           Excel</a>

                     </div>
                     <!-- /.card-header -->
                     <div class="card-bodys">
                        <table id="table_bb_deffer" class="table table-bordered table-hover">
                           <thead>
                              <tr>
                                 <th>#</th>
                                 <th>Blood Bank</th>
                        ...
                        <a href="#" id="load_more_link_deffer">View More</a>
...
//   excel URLS---------------
var bb_details_donor_excel_url='<?php echo $base_url;?>/bb_details_donor_excel_url';
...
$(document).ready(function () {
 ...
 var tabledeff = $('#table_bb_deffer').DataTable({
    ...
    "initComplete": function (settings, json) {
        ...
        $('#table_bb_deffer_paginate').hide();
    },
    "drawCallback": function (settings) {
        toggleLoadLinkdeferdonar();
        if (tabledeff.page.info().pages > 1) {
            $('#table_bb_deffer_paginate').show();
        } else {
            $('#table_bb_deffer_paginate').hide();
        }
    }
});
function toggleLoadLinkdeferdonar() {
    var totalRecords2 = tabledeff.page.info().recordsTotal;
    var currentLength2 = tabledeff.page.len();
    var link = $('#load_more_link_deffer');
    if (currentLength2 < totalRecords2) {
        link.text('View More');
    } else {
        link.text('View Less');
    }
}
$('#load_more_link_deffer').on('click', function (event) {
    event.preventDefault();
    var currentLength2 = tabledeff.page.len();
    var totalRecords2 = tabledeff.page.info().recordsTotal;

    if (currentLength2 < totalRecords2) {
        tabledeff.page.len(currentLength2 + 3).draw();
    } else {
        tabledeff.page.len(3).draw();
    }
    toggleLoadLinkdeferdonar();
});
toggleLoadLinkdeferdonar();

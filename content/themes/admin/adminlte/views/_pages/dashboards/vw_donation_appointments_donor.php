...
<div class="container">
 <div class="timeline">
   ...
   <!-- <div class="row" style="box-shadow: 0 0 1px rgb(0 0 0 / 13%), 0 1px 3px rgb(0 0 0 / 20%); 
   border-radius: 2px; width: 100%; margin-bottom: 25px; padding: 8px;">
      
      
      <div class="col-md-3">
      <div class="form-group">
      <label for="description">Blood Group</label>
      <select name="blood_group" id="daysfillter" class="form-control">                                  
         ...
         <div class="col-md-12">
            <div class="card-footer">
               <div class="btn-group" style="float: right;">
                  <button id="resetFiltersBtn" class="btn btn-sm btn-danger" >Reset</button>
               </div>
            </div>
         </div>
         ...
         <!-- <div class="row">
            ...
            <div class="col-xl-3 mb-50">
              <div class="bg-white widget-style1 border-radius-10 height-100-p box-shadow">
                <div class="d-flex flex-wrap">
                  <div class="circle-icon">
                    <div class="icon border-radius-100 font-24 text-blue"><i class="fa fa-handshake" aria-hidden="true"></i></div>
                  </div>
                  <div class="widget-data">
            ...
            <div class="col-xl-3 mb-50">
              <div class="bg-white box-shadow border-radius-10 height-100-p widget-style1">
                <div class="d-flex flex-wrap">
                  <div class="circle-icon">
                    <div class="icon border-radius-100 font-24 text-blue"><i class="fa fa-usd" aria-hidden="true"></i></div>
                  </div>
                  <div class="widget-data">
            ...
            <div class="col-12 mb-3">
                  <div class="cards">
                     <div class="card-headers">
                        <b class="card-titles">Donation Appointments</b>&nbsp;
                        <a id="downloadDO_APPexcelLink" href="#" style="text-decoration: underline; color: #0D2942;">Download
                           Excel</a>

                     </div>
                     <!-- /.card-header -->
                     <div class="card-bodys">
                        <table id="table_bb_donar_app" class="table table-bordered table-hover">
                           <thead>
                              <tr>
                                 <th>#</th>
                                 <th>Blood Bank</th>
                        ...
                        <a href="#" id="load_more_link_donar_req">View More</a>
...
//   excel URLS---------------
var bb_donnar_app_excel_url='<?php echo $base_url;?>/bb_donnar_app_excel_url';
...
$(document).ready(function () {
    ...
    "initComplete": function (settings, json) {
        ...
        $('#table_bb_donar_app_paginate').hide();
    },
    "drawCallback": function (settings) {
        toggleLoadLinkdonarapp();
        if (tabledonarapp.page.info().pages > 1) {
            $('#table_bb_donar_app_paginate').show();
        } else {
            $('#table_bb_donar_app_paginate').hide();
        }
    }
...
// ------------ link for donation request

function toggleLoadLinkdonarapp() {
    var totalRecords8 = tabledonarapp.page.info().recordsTotal;
    var currentLength8 = tabledonarapp.page.len();
    var link = $('#load_more_link_donar_req');
    if (currentLength8 < totalRecords8) {
        link.text('View More');
    } else {
        link.text('View Less');
    }
}
$('#load_more_link_donar_req').on('click', function (event) {
    event.preventDefault();
    var currentLength8 = tabledonarapp.page.len();
    var totalRecords8 = tabledonarapp.page.info().recordsTotal;

    if (currentLength8 < totalRecords8) {
        tabledonarapp.page.len(currentLength8 + 3).draw();
    } else {
        tabledonarapp.page.len(3).draw();
    }
    toggleLoadLinkdonarapp();
});
toggleLoadLinkdonarapp();

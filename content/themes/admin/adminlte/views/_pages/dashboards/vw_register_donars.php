   ...
   border-radius: 2px; width: 100%; margin-bottom: 25px; padding: 8px;">
      ...
      <div class="container-fluid pb-3">
               ...
               <div class="col-12 mb-3" >
                  <div class="cardss">
                     <div>
                        ...
                        <a id="downloadexcelLink" href="#" style="text-decoration: underline; color: #0D2942;">Download Excel</a>
                     </div>
                     <!-- /.card-header -->
                     <div class="card-bodyss">
                        <table id="table_bb_details" class="table table-bordered table-hover">
                           <thead>
                              <tr>
                                 <th>#</th>
                                 <th>Blood Bank</th>
                        ...
                        <a href="#" id="load_more_link_reg_donar">View More</a>
                     </div>
                     <!-- /.card-body -->
                  </div>
                  <!-- /.card -->
         ...
         <div class="row col-12">
               ...
               <b class="card-titles">Registered Donors</b>
               </div>
               <!-- /.card-header -->
               <div class="cards">
               <table id="table_bb_details"  class="table table-bordered table-hover">
...
//   excel URLS---------------
var bb_details_excel_url='<?php echo $base_url;?>/bb_details_excel_url';
//------------------------------------------
//var days_filter = 0;
...
$(document).ready(function () {
      ...
      "initComplete": function (settings, json) {
         ...
         $('#table_bb_details_paginate').hide();
      },
      "drawCallback": function (settings) {
         toggleLoadLinkregisterdonar();
         if (table.page.info().pages > 1) {
               $('#table_bb_details_paginate').show();
         } else {
               $('#table_bb_details_paginate').hide();
         }
      }
   });
   // ----------------- link for Donar register


function toggleLoadLinkregisterdonar() {
    var totalRecords1 = table.page.info().recordsTotal;
    var currentLength1 = table.page.len();
    var link = $('#load_more_link_reg_donar');
    if (currentLength1 < totalRecords1) {
        link.text('View More');
    } else {
        link.text('View Less');
    }
}
$('#load_more_link_reg_donar').on('click', function (event) {
    event.preventDefault();
    var currentLength1 = table.page.len();
    var totalRecords1 = table.page.info().recordsTotal;

    if (currentLength1 < totalRecords1) {
        table.page.len(currentLength1 + 3).draw();
    } else {

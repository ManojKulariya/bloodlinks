...
<div class="container">
    <form action="<?php echo base_url('hospital/Blood_request_submit_1') ?>" method="POST">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="description">Consultant Phone No. *</label>
                                <input type="number" class="form-control" name="consultant_phone"  required
                                onkeypress="return event.charCode >= 48 && event.charCode <= 57">

                                <!--<input type="tel" class="form-control" name="consultant" required>-->
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="clinical_history" >
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" value="<?= date('Y-m-d'); ?>" name="required_date" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="time" class="form-control"  value="<?= date('H:i'); ?>" name="required_time">
                            </div>
                        </div>
                        <div class="row col-12 m-3">
                            ...
                            <div class="form-group row col-3">
                                ...
                                <input type="checkbox" class="form-control" name="routine" checked>
...
document.querySelector("form").addEventListener("submit", function(e) {
    ...
    let checked = document.querySelectorAll(".comp-check:checked").length;

    if (checked === 0) {
        alert("Please select at least one Blood Component Requested.");

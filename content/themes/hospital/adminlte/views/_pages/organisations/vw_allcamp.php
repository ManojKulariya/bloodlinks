       ...
       $query = $this->db->query("SELECT * FROM bl_bloodcamp ORDER BY ID DESC"); }
         ...
         ?>
              ...
              <tr>
                  ...
                  <?php  if ($row->status =='0') { ?>
                  <td class="capitalize"><?php echo'<button type="button" class="btn btn-xs btn-dark" onclick="updateFun('.$row->id.');" >Dis Approve</button>' ?></td>
                <?php }else{ ?>
                  <td class="capitalize">Approve</td>
                <?php } ?>
 <?php 
   if ($_SESSION['admin_type'] =='0') {
$servies_per = $_SESSION['bloodbank_user_servies_permission'];

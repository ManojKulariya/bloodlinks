  		...
  		<div class="card-body">
            ...
            <div class="tab-content" id="custom-tabs-one-tabContent">
                  ...
                  <div class="tab-pane fade <?php echo (!session_userdata('next_step'))?'show active':'';?>" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
	                    ...
	                    <form id="hospital_basic_detail" role="form" novalidate>
	                    	...
	                    	<div class="col-md-12">
		                    	...
		                    	<div class="row">
										          ...
										          <div class="form-group">
										            <label for="org_name">Hospital Name</label>
												...
												<div class="row">
										         <div class="col-md-6">
										          ...
										          <div class="col-md-6">
										          <div class="form-group">
										            <label for="blood_center">Have Blood Center</label>
										            <select class="form-control" id="blood_center" name="blood_center" style="padding:0px !important;">
										            <!-- 	<option value="0">Select category</option> -->
										      ...
										      <div class="row pl-2 pr-2">
										        ...
										        <div class="col-md-6" id="components_div" style="display:<?php echo (isset($blood_bank_data) && ($blood_bank_data->component_facillity=="component")||"both")?'block':'none';?>;">
										        ...
										        <!--  <div class="col-md-3">
                        <div class="form-group">
					                    <label for="org_logo">Hospital Logo</label>
...
<script type="text/javascript">
	 var hospital_id='<?php echo (isset($hospital_id))?$hospital_id:'';?>';
	//var blood_bank_id='<?php echo (isset($blood_bank_id))?$blood_bank_id:'';?>';
  	var hospital_add_url='<?php echo $base_url;?>/hospitals_add';
  	var dist_search_url='<?php echo $base_url;?>/get_districts';
  	var city_search_url='<?php echo $base_url;?>/get_cities';
  	// var file_search_url='<?php echo $base_url;?>/hospitals_file_search';
  	// var file_delete_url='<?php echo $base_url;?>/hospitals_file_delete';
</script>
<script type="text/javascript">

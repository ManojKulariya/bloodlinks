	...
	<div class="col-12">
		...
		<div class="card">
			<div class="card-header m-2">
				<h3 class="card-title">Blood Bank Details </h3>
				<div class="btn-group" style="float: right;">
					<a href="<?php echo $base_url; ?>/bloodbanks" data-toggle="tooltip" title="" class="btn btn-sm btn-default" data-original-title="Add New"><i class="fas fa-reply fw"></i></a>
				</div>
			</div>
			<div class="card-body">
				...
				<div class="tab-content" id="custom-tabs-one-tabContent">
					...
					<div class="tab-pane fade <?php echo (!session_userdata('next_step')) ? 'show active' : ''; ?>" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
						...
						<form id="form_basic_details" role="form" novalidate>
							...
							<div class="col-md-12 pl-2 pr-2">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											<label for="org_category">Blood bank Logo</label>
											<input type="file" class="form-control mb-2" name="blood_bank_logo" id="blood_bank_logo" placeholder="Enter Helpline No" value="">
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="org_city form-control" id="org_city" name="org_city">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="form-control" id="org_component_facillity" name="org_component_facillity">
												<option value="" selected disabled>Select</option>
												<option value="component" <?php echo (isset($blood_bank_data) && ($blood_bank_data->component_facillity == 'component')) ? 'selected' : ''; ?>>Component</option>
												<option value="wb" <?php echo (isset($blood_bank_data) && ($blood_bank_data->component_facillity == 'wb')) ? 'selected' : ''; ?>>Whole Blood</option>
												<option value="both" <?php echo (isset($blood_bank_data) && ($blood_bank_data->component_facillity == 'both')) ? 'selected' : ''; ?>>Both</option>
											</select>
										</div>
									</div>

									<div class="col-md-6 mt-2 pb-3" id="components_div" style="display:<?php echo (isset($blood_bank_data) && ($blood_bank_data->component_facillity == "component") || "both") ? 'block' : 'none'; ?>;">

										<?php

										if (!empty($components)) {
											foreach ($components as $key => $value) {
											    $checked = ($value['component_id'] == 18) ? 'checked' : $value['selected'];
										?>
												<div class="form-group">
													<div class="custom-control custom-checkbox">
														<input class="custom-control-input" type="checkbox" <?php echo $checked; ?> name="org_available_components[]" id="org_available_components<?php echo $key; ?>" value="<?php echo $value['component_id']; ?>" <?php echo $value['selected']; ?>>
					...
					<div class="tab-pane fade <?php echo (session_userdata('next_step') && in_array(session_userdata('next_step'), array('mics_details'))) ? 'show active' : ''; ?>" id="custom-tabs-one-profile" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab">
						<form id="form_mics_details" role="form" novalidate>
							<div class="col-md-12" style="padding: 20px;">
								<div class="timeline">
									<div class="time-label">
										<span class="bg-red">Miscellaneous Informations</span>
									</div>
									<div class="card timeline-item" style="display: none;">
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="org_tariff_name" id="org_tariff_name" placeholder="Enter Tarrif Name" value="<?php echo (isset($blood_bank_misc_data)) ? $blood_bank_misc_data->misc_tariff_name : ''; ?>">
													</div>
												</div>
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="org_tariff_charge" id="org_tariff_charge" placeholder="Enter Charges In Rs" value="<?php echo (isset($blood_bank_misc_data)) ? $blood_bank_misc_data->misc_tariff_charge : ''; ?>">
													</div>
												</div>
											</div>
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="org_area_name" id="org_area_name" placeholder="Enter Area Name" value="<?php echo (isset($blood_bank_misc_data)) ? $blood_bank_misc_data->misc_area_name : ''; ?>">
													</div>
												</div>
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="org_area_usability" id="org_area_usability" placeholder="Enter Area Usability" value="<?php echo (isset($blood_bank_misc_data)) ? $blood_bank_misc_data->misc_area_usability : ''; ?>">
													</div>
												</div>
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="org_area_room_no" id="org_area_room_no" placeholder="Enter Area Room No." value="<?php echo (isset($blood_bank_misc_data)) ? $blood_bank_misc_data->misc_area_room_no : ''; ?>">
													</div>
												</div>
									...
									<div class="card timeline-item">
										<div class="card-header">
											...
											<span style="float: right;">
												<input type="radio" name="tab" value="yes" onclick="show1();" />
												Yes
												<input type="radio" name="tab" value="no" onclick="show2();" checked />
												No
											</span>
										</div>

										<div class="card-body timeline-body hide" id="div1">
											...
											<div class="row">
												...
												<div class="col-md-3">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="org_storage_name" id="org_storage_name" placeholder="Enter Storage Name" value="<?php echo (isset($blood_bank_misc_data)) ? $blood_bank_misc_data->misc_storage_name : ''; ?>">
													</div>
												</div>
												...
												<div class="col-md-3">
													<div class="form-group">
														...
														<select class="org_city form-control" id="org_city" name="org_city">
															...
															<option value="ERPC">ERPC</option>
															<option value="Whole blood">Whole blood</option>
															<option value="Plasma">Plasma</option>
														</select>
														<!-- <input type="text" class="form-control" name="org_storage_type" id="org_storage_type" placeholder="Enter Storage Type" value="<?php echo (isset($blood_bank_misc_data)) ? $blood_bank_misc_data->misc_storage_type : ''; ?>"> -->
													</div>
												</div>
												...
												<div class="col-md-3">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="org_storage_area_name" id="org_storage_area_name" placeholder="Enter Area Name" value="<?php echo (isset($blood_bank_misc_data)) ? $blood_bank_misc_data->misc_storage_area_name : ''; ?>">
													</div>
												</div>
												...
												<div class="col-md-3">
													...
													<div class="form-group">
														<label for="org_storage_area_name">Storage Licence</label>
														<input type="text" class="form-control" name="org_storage_licence" id="org_storage_area_name" placeholder="Enter Area Name" value="<?php echo (isset($blood_bank_misc_data)) ? $blood_bank_misc_data->misc_storage_licence : ''; ?>">
													</div>
												</div>
											</div>
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="org_refreshment_name" id="org_refreshment_name" placeholder="Enter Refreshment Name" value="<?php echo (isset($blood_bank_misc_data)) ? $blood_bank_misc_data->misc_refreshment_name : ''; ?>">
													</div>
												</div>
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="org_refreshment_quality" id="org_refreshment_quality" placeholder="Enter Refreshment Quantity" value="<?php echo (isset($blood_bank_misc_data)) ? $blood_bank_misc_data->misc_refreshment_qty : ''; ?>">
													</div>
												</div>
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="btn-group" style="float: right;">
											<button type="submit" class="btn btn-sm btn-danger btn_save_category" id="btn_save_mics_details"><i class="fas fa-save fw"></i> Save</button>
										</div>
									</div>
					...
					<div class="tab-pane fade <?php echo (session_userdata('next_step') && in_array(session_userdata('next_step'), array('doc_details'))) ? 'show active' : ''; ?>" id="custom-tabs-one-messages" role="tabpanel" aria-labelledby="custom-tabs-one-messages-tab">

						<div class="row">
							<div class="col-md-12" style="padding: 20px;">
								<form id="form_documents_details" enctype="multipart/form-data" role="form" novalidate>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label for="org_constitution_doc">Constitution Document</label>
												<div class="input-group">
													<div class="custom-file">
														<input type="file" class="custom-file-input" id="org_constitution_doc" name="org_constitution_doc">
														<label class="custom-file-label" for="org_constitution_doc">Choose file</label>
													</div>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label for="org_pan_card">PAN Card</label>
												<div class="input-group">
													<div class="custom-file">
														<input type="file" class="custom-file-input" id="org_pan_card" name="org_pan_card">
														<label class="custom-file-label" for="org_pan_card">Choose file</label>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label for="org_12_aa_doc">12 AA Document</label>
												<div class="input-group">
													<div class="custom-file">
														<input type="file" class="custom-file-input" id="org_12_aa_doc" name="org_12_aa_doc">
														<label class="custom-file-label" for="org_12_aa_doc">Choose file</label>
													</div>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label for="org_12_ab_doc">12 AB Document</label>
												<div class="input-group">
													<div class="custom-file">
														<input type="file" class="custom-file-input" id="org_12_ab_doc" name="org_12_ab_doc">
														<label class="custom-file-label" for="org_12_ab_doc">Choose file</label>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label for="org_80_g_doc">80 G Document</label>
												<div class="input-group">
													<div class="custom-file">
														<input type="file" class="custom-file-input" id="org_80_g_doc" name="org_80_g_doc">
														<label class="custom-file-label" for="org_80_g_doc">Choose file</label>
													</div>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label for="org_lic_doc">Blood Center License</label>
												<div class="input-group">
													<div class="custom-file">
														<input type="file" class="custom-file-input" id="org_lic_doc" name="org_lic_doc">
														<label class="custom-file-label" for="org_lic_doc">Choose file</label>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label for="org_competent_auth_doc">Registration with Competent Authority Document</label>
												<div class="input-group">
													<div class="custom-file">
														<input type="file" class="custom-file-input" id="org_competent_auth_doc" name="org_competent_auth_doc">
														<label class="custom-file-label" for="org_competent_auth_doc">Choose file</label>
													</div>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label for="org_competent_person_doc">Document Related Change in the Competent person</label>
												<div class="input-group">
													<div class="custom-file">
														<input type="file" class="custom-file-input" id="org_competent_person_doc" name="org_competent_person_doc[]" multiple>
														<label class="custom-file-label" for="org_competent_person_doc">Choose file</label>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="row">
										...
										<div class="col-md-12">
											<div class="btn-group" style="float: right;">
												<button type="submit" class="btn btn-sm btn-danger btn_save_category" id="btn_save_docs"><i class="fas fa-save fw"></i> Save</button>
											</div>
										</div>
						...
						<div class="row">
							<div class="col-md-12" style="padding: 20px;">
								...
								<table id="table_blood_banks_files" class="table table-bordered table-hover" style="width:100% !important;">
									<thead>
										<tr>
											<th>#</th>
											<th>File Type</th>
...
<script type="text/javascript">
	var blood_bank_id = '<?php echo (isset($blood_bank_id)) ? $blood_bank_id : ''; ?>';
	var blood_banks_add_url = '<?php echo $base_url; ?>/bloodbanks_add';
	var dist_search_url = '<?php echo $base_url; ?>/get_districts';
	var city_search_url = '<?php echo $base_url; ?>/get_cities';
	var file_search_url = '<?php echo $base_url; ?>/bloodbanks_file_search';
	var file_delete_url = '<?php echo $base_url; ?>/bloodbanks_file_delete';
</script>
<script type="text/javascript">
	function show1() {

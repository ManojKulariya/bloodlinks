...
<div class="row">
  <div class="col-6">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Discard Reason</h3>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
        <table id="table_discard_reason" class="table table-bordered table-hover">
          <thead>
          <tr>
            <th>#</th>
            <th>Type Name</th>
  ...
  <div class="col-6">
    <div class="card">
      ...
      <!-- /.card-header -->
      <form role="form" id="form_discard_reason">
        <input type="hidden" name="masters_id" id="masters_id">
        <div class="card-body">
          <div class="form-group">
            <label for="masters_value">Type Name</label>
            <input type="text" class="form-control" id="masters_value" name="masters_value" placeholder="Enter discard reason">
          </div>
          <div class="form-group">
               ...
               success:function(d){
                 // console.log (d);
                  if(d==1){
                     ...
                     $('#table_discard_reason').DataTable().ajax.reload();
                  }
                  else{
                     alert('Delete Fail');
                  }

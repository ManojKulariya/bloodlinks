...
<div class="container" id="printPageButton">
  <form action="<?php echo base_url('admin/donations/master_tti_register'); ?>" method="GET">
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md-3">
                <div class="card-footer">
                    <div class="btn-group" style="float: right;">
                        <a href="<?= base_url('admin/donations/master_tti_register'); ?>" class="btn btn-sm btn-success">Reset</a>
                    </div>
                </div>
            </div>
          </div>
...
<h6 style="text-align: center;line-height:1;"><?php echo ($bloodbank->name) ?><br> A UNIT OF VITA HEE CARE TRUST<br>
  <?php echo ($bloodbank->address_1) ?></br><span style="text-align: center;font-weight: bold;">Transfusion Transmissble Disease Register</span> </h6>
  
  <table  style="border: 1px solid black;font-family: arial, sans-serif;border-collapse: collapse;width: 100%;font-size: 12px;">
    <tr>
      <th style="width: 11%;border: 1px solid black; text-align: center;">Date</th>
      <th style="width: 11%;border: 1px solid black; text-align: center;">Blood Unit No.</th>
      <th style="width: 11%;border: 1px solid black; text-align: center;">HBsAg</th>
      <th style="width: 11%;border: 1px solid black; text-align: center;">HIV</th>
      <th style="width: 11%;border: 1px solid black; text-align: center;">HCV</th>
      <th style="width: 11%;border: 1px solid black; text-align: center;">VDRL</th>
      <th style="width: 11%;border: 1px solid black; text-align: center;">MP</th>
      <th style="width: 11%;border: 1px solid black; text-align: center;">Remark</th>
      <th style="width: 11%;border: 1px solid black; text-align: center;">Signature</th>
    </tr>
    ...
    ?>
      <tr style="width: 100%;">
        <td style="border: 1px solid black; text-align: center;"><?= date('d-m-Y', strtotime($ms['donation_date'])) ?></td>
        <td style="border: 1px solid black; text-align: center;"><?= $ms['unit_no'] ?></td>
        <td style="border: 1px solid black; text-align: center;"><?= $ms['hbsag'] ?></td>
        <td style="border: 1px solid black; text-align: center;"><?= $ms['hiv'] ?></td>
        <td style="border: 1px solid black; text-align: center;"><?= $ms['hcv'] ?></td>
        <td style="border: 1px solid black; text-align: center;"><?= $ms['vdrl'] ?></td>
        <td style="border: 1px solid black; text-align: center;"><?= $ms['malaria'] ?></td>
        <td style="border: 1px solid black; text-align: center;"></td>
        <td style="border: 1px solid black; text-align: center;"><?php if ($ms['sign'] != "") {
          echo '<img src="' . $base_url . '/' . $ms['sign'] . '" width="70px" height="65px" />';
        } ?></td></td>
